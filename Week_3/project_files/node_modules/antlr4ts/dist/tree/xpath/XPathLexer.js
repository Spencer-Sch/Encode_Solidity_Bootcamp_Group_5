...
class XPathLexer extends __2.Lexer {
    ...
    constructor(input) {
        super(input);
        this._interp = new __3.LexerATNSimulator(XPathLexer._ATN, this);
    }
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    static get _ATN() {
        if (!XPathLexer.__ATN) {
            XPathLexer.__ATN = new __1.ATNDeserializer().deserialize(Utils.toCharArray(XPathLexer._serializedATN));
        }
...
XPathLexer.VOCABULARY = new __4.VocabularyImpl(XPathLexer._LITERAL_NAMES, XPathLexer._SYMBOLIC_NAMES, []);
