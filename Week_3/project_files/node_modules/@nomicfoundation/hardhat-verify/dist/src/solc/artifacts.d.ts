import { Artifacts, BuildInfo, CompilerInput, CompilerOutputBytecode, CompilerOutputContract, Network } from "hardhat/types";
...
export declare type ExtendedContractInformation = ContractInformation & LibraryInformation;
export declare type LibraryToAddress = Record<string, string>;
export declare type SourceToLibraryToAddress = Record<string, LibraryToAddress>;
