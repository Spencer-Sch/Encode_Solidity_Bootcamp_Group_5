...
class NetworkNotSupportedError extends HardhatVerifyError {
    constructor(network) {
        super(`The selected network is ${network}. Please select a network supported by Etherscan.`);
    }
}
