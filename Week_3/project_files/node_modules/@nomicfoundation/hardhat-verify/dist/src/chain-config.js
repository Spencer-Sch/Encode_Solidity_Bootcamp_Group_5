...
exports.builtinChains = exports.getCurrentChainConfig = void 0;
const plugins_1 = require("hardhat/plugins");
const errors_1 = require("./errors");
async function getCurrentChainConfig({ name, provider }, customChains) {
    ...
    if (currentChainConfig === undefined) {
        if (name === plugins_1.HARDHAT_NETWORK_NAME) {
            throw new errors_1.NetworkNotSupportedError(name);
        }
